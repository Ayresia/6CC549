...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'GET' && $signedIn = current_user()) {
    header('Location: ' . home_for($signedIn));
    exit;
}
...
$pageDescription = 'Sign in to manage the offers and branch details shown on the Book & Board website.';
$navHere         = 'login';
      ...
      <div class="col-md-9 col-lg-6 col-xl-5 mx-auto">
        ...
        <div class="card">
          <div class="card-body p-4 p-md-5">
            ...
            <h1 class="h3 mb-1" id="login-heading">Staff sign in</h1>
            <p class="text-body-secondary">
              This is for Book &amp; Board staff. Sign in to add, edit and take down the offers and branch
            ...
            <form method="post" action="login.php" aria-labelledby="login-heading" novalidate>
              ...
              <p class="mb-0">
                Looking for a holiday? <a href="offers.php">See our current offers</a>, or
                <a href="contact.php">get in touch</a> and an agent will help.
              </p>
