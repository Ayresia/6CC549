...
<footer class="bg-dark text-light py-5" data-bs-theme="dark">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-6 col-lg-4">
        <h2 class="h6 text-uppercase mb-3">Your account</h2>
        <ul class="list-unstyled mb-0">
          <?php if ($user): ?>
            <?php if ($user['role'] === 'staff'): ?>
              <li class="mb-2"><a class="link-light" href="staff/offers.php">Manage offers</a></li>
            <?php else: ?>
              <li class="mb-2"><a class="link-light" href="account.php">My account</a></li>
            <?php endif; ?>
            <li><a class="link-light" href="login.php?signout=1">Sign out</a></li>
          <?php else: ?>
            <li class="mb-2"><a class="link-light" href="login.php">Sign in</a></li>
            <li><a class="link-light" href="register.php">Register</a></li>
          <?php endif; ?>
        </ul>
      </div>
